...
ActiveRecord::Schema[7.0].define(version: 2023_08_17_091453) do
  ...
  create_table "photographers", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  add_foreign_key "messages", "photographers"
